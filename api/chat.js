// api/chat.js
// serverless function ini jalan di server vercel, BUKAN di browser.
// api key diambil dari environment variable, jadi gak pernah nongol
// di source code yang lo push ke github.
...
module.exports = async (req, res) => {
  ...
  if (!API_KEY) {
    res.status(500).json({
      error: { message: 'GEMINI_API_KEY belum di-set di environment variable vercel' }
    });
    return;
  }
