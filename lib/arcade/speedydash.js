...
/* ============ HP ============ */
function updHP(){var e=document.getElementById('hpEl');if(e)e.textContent=new Array(hp+1).join('\u2764')+new Array(hpMax-hp+1).join('\u2661')}
...
hp--;iframe=120;sHurt();shake=10;flash=.6;wob.v=1.1;popup(CX,CY-26,'-1 HP','#ff5c7a');updHP();
if(hp<=0)die();
}
