// lib/arcade/speedydash.js — port dari plugins/game/speedydash.js bot WA
...
<div class="gw"><canvas id="cv" width="404" height="300"></canvas><div id="hpEl" style="position:absolute;top:6px;right:10px;z-index:5;font:900 15px Arial;color:#ff5c7a;text-shadow:0 0 8px #000,0 1px 2px #000;letter-spacing:2px">&#10084;&#10084;&#10084;</div></div>
...
laser=null;boss=null;bossWarnT=0;bossNext=50;laserCd=520;hp=hpMax;regenT=0;updHP();
...
/* ============ HP ============ */
function updHP(){var e=document.getElementById('hpEl');if(e)e.textContent=new Array(hp+1).join('\u2764')+new Array(hpMax-hp+1).join('\U0001F5A4')}
...
if(laserHit&&laser&&laser.fromBoss){hp--;iframe=120;sHurt();shake=10;flash=.6;wob.v=1.1;popup(CX,CY-26,'-1 HP','#ff5c7a');updHP();if(hp<=0){die()}return}
...
if(state==='play'&&hp<hpMax){regenT++;if(regenT>900){hp++;regenT=0;updHP();popup(CX,CY-40,'+1 HP','#7dff9a')}}
...
/* ============ LOOP + 60FPS FRAME LOCK ============ */
var perfA=0,perfN=0,perfDone=false,lastT=0;
var fpsInterval=1000/60, then=performance.now();
...
if(!perfDone&&perfN>60&&perfN<160)perfA+=(now-lastT);
...
/* =========================================================
 * SIGNATURE & CERTIFICATES (WA WEBVIEW PROOFS)
 * ========================================================= */</body></html>`;

module.exports = {
  config: { key: "speedydash", name: "Speedy Dash", emoji: "🏃", desc: "endless runner hindari rintangan" },
  build: () => HTML,
};
