// lib/arcade/dino.js — port dari plugins/game/dino.js bot WA
const HTML = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"></head><style>*{-webkit-tap-highlight-color:transparent;-webkit-user-select:none;user-select:none;-webkit-touch-callout:none}</style>
...
<div><div style="font-size:11px;letter-spacing:1.5px;color:rgba(255,255,255,.45)">NOX DINO</div><div style="font-size:21px;font-weight:bold;color:#fff">Dino Runner</div></div>
...
module.exports = {
  config: { key: "dino", name: "Dino Runner", emoji: "🦖", desc: "lari lompat kaktus ala chrome dino" },
  build: () => HTML,
};
